...
--#region 1. MAIN
    ...
    function _update60()
        ...
        if game == "menu" then
            update_menu()
        elseif game == "transition" then
            update_menu()
            menu_time+=1
            if menu_time >= 90 and #corpses == 0 then
                game = "play"
            end
    ...
    function update_corpses()
        if #corpses > 0 then
            for corpse in all(corpses) do
                if #corpse.pixels == 0 then
                    del(corpses,corpse)
                end
                if game == "transition" and transition_t <2 then
                    corpse.delay=60
                    transition_t+=1
                end
                corpse.delay -= gt
                ...
                for p in all(corpse.pixels) do
                    ...
                    if p.dust == true then
                        ...
                        if life >= 75 and p.clr != 14 and p.clr != 8 and p.clr != 6 then 
                            if rnd_clr == 1 then
                                p.clr = 4
                        ...
                        if life == 40 and p.clr == 6 then
                            p.clr = 4
                        end
                        if life == 25 and p.clr == 5 then
                            p.clr = 2
                        end
                        --dust deletion
                        if life <= 0 then
...
--#region 7. BACKGROUND
    ...
    function update_bg()
        ...
        if #corpses <= 0 and game == "menu" then
            corpse = make_corpse(49,73,1,96,121,31,7,30000)
            add(corpses,corpse)
            corpse = make_corpse(60,plr.y,1,3,0,9,24,30000)
            add(corpses,corpse)
...

__sfx__
...
14020000164731767011473084731767015675126750e6750c6750967506675036750167500665006550064500635006250061500605006050000500001000011700100001000000000000000000000000000000
